                        ...
                        <ul>
                            ...
                            <li>
                                <div class="message-center">
                                    ...
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"> <img src="<?= base_url('assets/images/users/2.jpg'); ?>" 
                                    ...
                                    <!-- Message -->
                                    <a href="#">
                                        <div class="user-img"> <img src="<?= base_url('assets/images/users/3.jpg'); ?>" 
                                    ...
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active">
                                            <div class="container"> <img class="d-block img-fluid" 
                                                src="<?= base_url('assets/images/big/img1.jpg'); ?>" alt="First slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container">
                                                <img    class="d-block img-fluid" 
                                                        src="<?= base_url('assets/images/big/img2.jpg'); ?>" 
                                                        alt="Second slide"></div>
                                        </div>
                                        <div class="carousel-item">
                                            <div class="container"><img class="d-block img-fluid"                                                 
                                                src="<?= base_url('assets/images/big/img3.jpg'); ?>" 
                                                alt="Third slide"></div>
                                        </div>
                                    </div>
