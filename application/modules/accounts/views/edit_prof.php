...
<form action="<?=base_url('accounts/editProfileUrl/' . $profDet['id']);?>"
    ...
    <div class="form-group row">
      <label for="close_rate" class="col-2 col-form-label">
        Close Rate <i class="mytooltip mdi mdi-tooltip-text">
          <span class="tooltip-content customTool text-white">Close rate - Your closing ratio is the number of sales you close compared to the number of leads. Say, for inclose_ratestance, you have 10 last month and closed 2 sales as a result. You closed 2/10ths, or 20 percent, of your potential sales.</span></i>
        </i>
      </label>
      <div class="col-2">
    ...
    <div class="form-group row">
      <label for="avg_sale_amount" class="col-2 col-form-label">Avg. Sale Amt.
    ...
    <div class="form-group row">
      <label for="ltv_amount" class="col-2 col-form-label">LTV Amt.
        <i class="mytooltip mdi mdi-tooltip-text">
