		...
		if ($fetchedProfile) {
			...
			foreach ($gPages as $key => $gPage) {
				try {
					...
					$loc_name = $gPageLoc['account_page_location_name'];
					com_e($gPage, 0);
					com_e($page_name, 0);
					com_e($gPageLoc, 0);
